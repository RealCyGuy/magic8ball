list = [
    ...
    '\"Don\'t take advice from a list.\" - Abraham Lincoln',
    'Ask again in 3.8 minutes.',
    'Yes, definitely is not the opposite of yes, definitely not.',
    ...
    '<insert answer here>',
    'Answer generating... Due to spam, verification is needed to prove you\'re not a bot. Please do 3.49e45 serveys to prove humaness.',
    'Hmm...',
    'The answer you have been waiting for *Drumroll*: <Try again later.>',
    'Yes, your answer is no.',
    'Please insert disk 5 to continue.',
    'Answer finder - CRITICAL status: Answer is undefined.',
    'Connection timeout. Ask again in 483753047583850 years.',
    'Your answer has been destroyed.'
]